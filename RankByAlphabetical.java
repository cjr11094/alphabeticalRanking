...
public class RankByAlphabetical {
	...
	HashMap <Character, Integer> letters = new HashMap <Character, Integer>();	// contains count of each letter in the input word
	char [] wordLetters;
	 ...
	 * 
	 * I found a formula on the internet that will basically calculate the total number of anagrams for a given word:
